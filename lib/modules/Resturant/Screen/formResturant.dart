                ...
                Container(
                  ...
                  child: ClipRRect(
                    child: GestureDetector(
                      onTap: () {
                        openImagePickerModal(context).then((value) async {
                          if (value != null) {
                            setState(() {
                              _isUploadingImage = true;
                            });
                            await uploadFile(value, "profile-photo", token)
                                .then((value) =>
                                    resturantModel.avatar = value['uriPath']);
                        ...
                        child: _isUploadingImage
                            ...
                            : resturantModel.avatar != null
                                ? ClipRRect(
                                    ...
                                    child: Image.network(resturantModel.avatar))
                            ...
                            child: TextFormFieldResturant(
                              ...
                              onSave: (value) {
                                setState(() {
                                  ...
                                  print("re ${resturantModel.resturantName}");
                                });
                              },
                            ),
                          ),
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => PlacePicker(
                                      ...
                                      onPlacePicked: (result) {
                                        ...
                                        resturantModel.location = locationMo;
